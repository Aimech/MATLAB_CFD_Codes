%% Code to solve the 1D Wave Eqauation using FTBS scheme
...
u_Ex = Wave(u, dx, a, t, T, 0.016666666666666667);
% For CFL number equal to 0.9996
u_C1 = Wave(u, dx, a, t, T, 0.01666);
% For CFL number equal to 0.9
u_C2 = Wave(u, dx, a, t, T, 0.015);
% For CFL number equal to 0.45
u_C3 = Wave(u, dx, a, t, T, 0.0075);
